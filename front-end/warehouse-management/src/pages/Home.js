...
export default function Home (props) {
  ...
  async function handleSignInSubmit(e) {
    e.preventDefault()
    const response = await fetch(`http://${process.env.DATABASE_URI}:${process.env.DATABASE_PORT}/authentication`, {
      method: 'POST',
      headers: {
  ...
  async function handleSignUpSubmit(e) {
    e.preventDefault()
    console.log(user)
    await fetch(`http://${process.env.DATABASE_URI}:${process.env.DATABASE_PORT}/users/`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
